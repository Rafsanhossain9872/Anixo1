...
export function PopunderControlButton() {
  ...
  return (
    <button
      ...
      className="flex items-center gap-2 px-4 py-2.5 rounded-full bg-red-900/20 border border-red-500/20 hover:bg-red-800/30 transition-all duration-200 active:scale-95"
