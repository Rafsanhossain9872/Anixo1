...
export default function NextEpisodeBanner({ anime }) {
  ...
  return (
    <div className="w-full bg-[#0d0d0d] border border-white/15 rounded-[4px] overflow-hidden mb-6 sm:mb-8 group transition-all">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between px-3 py-2.5 sm:px-4 sm:py-3 gap-3 sm:gap-4">
        ...
        {timeLeft && (
          <div className="flex items-center justify-between sm:justify-end gap-4 py-1.5 px-3 sm:p-0 bg-white/[0.03] sm:bg-transparent rounded-[2px] border border-white/15 sm:border-0">
